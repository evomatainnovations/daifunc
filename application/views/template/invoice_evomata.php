			...
			<div id="content" style="width: 100%;">
				<?php
					...
					for($j=0;$j<count($temp_copies);$j++) {
            			...
            			$content.= '<tr><td colspan="2"><div style="text-align: left;font-size:1.5em;font-weight:bold;">Tax Invoice</div></td><td colspan="5"><div style="text-align: left;">'.$temp_copies[$j]->iutc_copies.'</div></td></tr>';
						...
						$content .= '<tr><td>Invoice No.</td><td>:</td><td>'.$s_txn_id.'</td></tr><tr><td>Date</td><td>:</td><td>'.date('d-m-Y',strtotime($s_txn_date)).'</td></tr>';
