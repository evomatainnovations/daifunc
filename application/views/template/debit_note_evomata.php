			...
			<div id="content" style="width: 100%;">
				<?php
					...
					for($j=0;$j<count($temp_copies);$j++) {
            			...
            			$content.= '<tr><td colspan="2"><div style="text-align: left;font-size:1.5em;font-weight:bold;">Debit Note</div></td><td colspan="5"><div style="text-align: left;">'.$temp_copies[$j]->iutc_copies.'</div></td></tr>';
