...
<main class="mdl-layout__content">
    <div class="mdl-grid">
        <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored" id="print" style="margin: 20px; width: 100%;">Print this document</button>
    </div>
		...
		<div class="mdl-cell mdl-cell--4-col">
			<div class="mdl-card mdl-shadow--4dp">
				...
				<div class="mdl-card__supporting-text">
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input type="text" id="s_expense" class="mdl-textfield__input" value="<?php if(count($txn_transport) > 0 ) echo $txn_transport[0]->ie_amount; ?>">
						<label class="mdl-textfield__label" for="s_expense">Transport Expense</label>
					</div>
				</div>
				<hr>
				<div>
					<button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect" id="update" style="margin: 20px; width: 90%;">Update</button>
				</div>
		...
		<div class="mdl-cell mdl-cell--8-col">
			<div id="content" style="width: 100%;">
				...
				// 		$content.= '<hr>';
					...
					for($j=0;$j<count($typearr);$j++) {
					    $content.= '<td id="'.$typeidarr[$j].'" style="padding-right:10px;padding-left:10px;">';
