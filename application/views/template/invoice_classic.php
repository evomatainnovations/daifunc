		...
		<article>
			...
			<?php
				...
				for($j=0;$j < count($property); $j++){
					echo '<p>'.$property[$j]->iexteinpt_property_value.'</p>';
				}
				// for($j=0;$j < count($basic); $j++){
				// 	echo '<p>'.$basic[$j]->icbd_value.'</p>';
				// }
			?>
			</address>
			<table class="meta">
				...
				<tr>
					...
					<td><span><?php echo $u_gst; ?></span></td>
				</tr>
				<tr>
			...
			<table class="inventory">
				...
				<?php	
					for($k=0;$k< count($details);$k++){
						...
						echo '</span>';
						echo '</td><td style="text-align: center;"><span>'.$details[$k]->iexteinpd_rate.'</span></td><td style="text-align: center;"><span>'.$details[$k]->iexteinpd_qty.'</span></td><td style="text-align: center;"><span>'.$details[$k]->ittxg_group_name.'</span></td>';
						$disc = 0;
						if($details[$k]->iexteinpd_discount != ''){
							echo '<td style="text-align: center;"><span>'.$details[$k]->iexteinpd_discount.'</span></td>';
