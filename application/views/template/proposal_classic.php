		...
		<article>
			...
			<?php
				...
				for($j=0;$j < count($property); $j++){
					echo '<p>'.$property[$j]->iexteppt_property_value.'</p>';
				}
			?>
			</address>
			<table class="meta">
			...
			<table class="inventory">
				...
				<?php	
					for($k=0;$k< count($details);$k++){
						...
						echo '</span></td><td style="text-align: center;"><span>'.$details[$k]->iexteprod_rate.'</span></td><td style="text-align: center;"><span>'.$details[$k]->iexteprod_qty.'</span></td><td style="text-align: center;"><span>'.$details[$k]->ittxg_group_name.'</span></td>';
						$disc = 0;
						if($details[$k]->iexteprod_discount != ''){
							echo '<td style="text-align: center;"><span>'.$details[$k]->iexteprod_discount.'%</span></td>';
