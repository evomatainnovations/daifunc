		...
		<article>
			...
			<?php
				...
				for($j=0;$j < count($property); $j++){
					echo '<p>'.$property[$j]->iextamcpt_property_value.'</p>';
				}
			?>
			</address>
			<table class="meta">
			...
			<table class="inventory">
				...
				<?php	
					for($k=0;$k< count($details);$k++){
						...
						echo '</span></td><td style="text-align: center;"><span>'.$details[$k]->iextamcpd_qty.'</span></td><td style="text-align: right;"><span>'.$details[$k]->iextamcpd_serial_number.'</span></td></tr>';
					}
				?>	
				</tbody>
			</table>
