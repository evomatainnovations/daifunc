		...
		<div class="mdl-cell mdl-cell--8-col">
			<div class="mdl-card mdl-shadow--4dp">
				<div class="mdl-card__title">
					<h2 class="mdl-card__title-text">Course Details</h2>
				</div>
				<div class="mdl-card__supporting-text">
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						...
						<label class="mdl-textfield__label" for="p_name">Enter Course Name</label>
					</div>
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						...
						<label class="mdl-textfield__label" for="p_sprice">Enter Course Price</label>
					</div>
				</div>
			</div>
		</div>
...
<script>
	$(document).ready(function() {
		...
		$('#submit').click(function(e) {
			...
			var product_price = $('#p_sprice').val();
			

			$.post('<?php if (isset($edit_product)) { echo base_url()."Education/update_course/".$pid; } else { echo base_url()."Education/save_course"; } ?>', {
				'name' : product_name,
				'alias' : product_alias,
				'price' : product_price,
				'feature' : pfeature,
				...
				window.location = '<?php echo base_url()."Education/courses"; ?>';
			}, 'text');
