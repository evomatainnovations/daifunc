	...
	<div class="mdl-grid">
		...
		<?php
			if (isset($edit_customer)) {
				echo '<div class="mdl-cell mdl-cell--4-col" style="text-align: center;">';
				echo '<a href="';
				echo base_url().'education/confirm_enquiry/'.$cid;
				echo '"><button class="mdl-button mdl-button-upside mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" style="width:100%;margin-left:0px !important;margin-right:0px !important;">Convert Enquiry to Student</button></a>';
				echo '</div>';
				echo '<div class="mdl-cell mdl-cell--4-col" style="text-align: center;">';
				echo '<a href="';
				echo base_url().'education/follow_up/enquiry/'.$cid;
				echo '"><button class="mdl-button mdl-button-upside mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" style="width:100%;margin-left:0px !important;margin-right:0px !important;">Add follow up</button></a>';
				echo '</div>';
				echo '<div class="mdl-cell mdl-cell--4-col">';
				echo '<a href="';
				echo base_url().'education/delete_enquiry/'.$cid;
				echo '"><button class="mdl-button mdl-button-upside mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent" style="width:100%;margin-left:0px !important;margin-right:0px !important;">Delete Enquiry</button></a>';
				echo '</div>';
	...
	$(document).ready(function() {
		...
		$('#submit').click(function(e) {
			...
			<?php 
				...
				if (isset($edit_customer)) {
					echo "$.post('".base_url()."education/update_enquiry/".$cid."', {'name' : customer_name, 'new_property' : c_new_data, 'value' : c_value, 'tags' : customer_info }, function(data, status, xhr) { window.location = '".base_url()."education/enquiry' }, 'text');";
				} else {
					echo "$.post('".base_url()."education/save_enquiry', {'name' : customer_name, 'new_property' : c_new_data, 'value' : c_value, 'tags' : customer_info }, function(data, status, xhr) { window.location = '".base_url()."education/enquiry'}, 'text');";
				}
			?>
