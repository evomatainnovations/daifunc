			...
			<table class="mdl-data-table mdl-js-data-table mdl-shadow--4dp" style="width: 100%;">
				<thead>
					<tr>
						...
						<th class="mdl-data-table__cell--non-numeric">Renewal</th>
						<th class="mdl-data-table__cell--non-numeric">Storage</th>
						<th class="mdl-data-table__cell--non-numeric">Group Creation</th>
					</tr>
				</thead>
				<tbody>
					<?php
						for ($i=0; $i < count($customer) ; $i++) { 
							...
							echo '<td class="mdl-data-table__cell--non-numeric">'.$customer[$i]->i_subscription_renew;
							echo '<td class="mdl-data-table__cell--non-numeric">'.$customer[$i]->i_storage;
							echo '<td class="mdl-data-table__cell--non-numeric">'.$customer[$i]->i_g_limit;
							echo "</tr>";
						}
					?>
				</tbody>
