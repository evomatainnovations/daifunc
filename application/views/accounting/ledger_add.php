...
<script>
	...
	$(document).ready(function() {
		// <?php 
		//if (isset($detail_prop)) { echo "cnt=".count($detail_prop);} ?>
  ...
  // ?>
		...
		$('#del').click(function(e) {
    		e.preventDefault();
    		window.location = "<?php if (isset($detail)) echo base_url().'Accounting/delete_ledger/'.$code.'/'.$lid; ?>";
    	});
        ...
        $('#type').change(function(e) {
            sel_type=$(this).val();
            $('#entity').autocomplete({ 
                source : '<?php echo base_url()."Accounting/fetch_link_type/".$code.'/'; ?>' + sel_type
            });
        })
    	...
    	$('#submit').click(function(e) {
			...
			$.post('<?php if(isset($detail)) { echo base_url()."Accounting/save_ledger/".$code.'/'.$lid; } else { echo base_url()."Accounting/save_ledger/".$code; } ?>', {
			    'name': $('#vendors').val(),
			    'groups' : $('#mygroups').val(),
			    'link_type' : $('#type').val(),
