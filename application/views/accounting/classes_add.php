			...
			<div class="mdl-card mdl-shadow--4dp">
				...
				<div class="mdl-card__supporting-text" style="width: auto;">
				    <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						<input type="text" id="vendors" class="mdl-textfield__input" value="<?php if(isset($detail)) echo $detail[0]->iextetacc_name; ?>">
						<label class="mdl-textfield__label" for="vendors">Class Name</label>
					</div>
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
					    <select id="type" class="mdl-textfield__input">
					        <option value="credit" <?php if(isset($detail)) if($detail[0]->iextetacc_type=="credit") echo 'selected'; ?>>Credit</option>
					        <option value="debit" <?php if(isset($detail)) if($detail[0]->iextetacc_type=="debit") echo 'selected'; ?>>Debit</option>
					    </select>
...
<script>
	...
	$(document).ready(function() {
    	...
    	$('#del').click(function(e) {
    		e.preventDefault();
    		window.location = "<?php if (isset($detail)) echo base_url().'/Accounting/delete_classes/'.$code.'/'.$cid; ?>";
    	});
    	...
    	$('#submit').click(function(e) {
			...
			$.post('<?php if(isset($detail)) { echo base_url()."/Accounting/save_classes/".$code.'/'.$cid; } else { echo base_url()."/Accounting/save_classes/".$code; } ?>', {
			    'name': $('#vendors').val(),
			    'type' : $('#type').val()
			 }, function(d,s,x) {
