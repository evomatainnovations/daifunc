...
<script>
    ...
    $(document).ready(function() {
		...
		$('#details').on('click','.edit', function(e) {
            e.preventDefault();
        	window.location = "<?php echo base_url().'Accounting/journal_entry_details/j/'.$code.'/'; ?>" + $(this).prop('id');
        });
		
		$('#details').on('click','.delete', function(e) {
            e.preventDefault();
            $(this).attr('disabled','disabled');
            $.post('<?php echo base_url()."Accounting/delete_journal_entry/".$code.'/'; ?>' + $(this).prop('id'), {}, function(d,s,x) {
                var b = JSON.parse(d);
    		    fill_main_table(b);
            }, "text"); 
        });
		...
		$('#add').click(function(e) {
			e.preventDefault();
			window.location = "<?php echo base_url().'Accounting/journal_entry_details/j/'.$code.'/'; ?>";
		});
