			...
			<div class="mdl-card mdl-shadow--4dp">
				...
				<div class="mdl-card__supporting-text">
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						...
						<label class="mdl-textfield__label" for="c_name">Enter Lead Name</label>
					</div>
					...
					<?php
            			if (isset($edit_customer)) {
            				...
            				// echo '<a href="'.base_url().'Enterprise/delete_customer/'.$cid.'"><button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--accent" style="width:100%;margin-left:0px !important;margin-right:0px !important;">Delete</button></a>';
            				// echo '</div>';
            			}
            		?>
				</div>
...
<script>
	...
	$(document).ready(function() {
		...
		$('#submit').click(function(e) {
			...
			// console.log(c_new_data);
			// console.log(customer_info);
			// console.log(customer_name);
			
			// var lid = "";
            $.post('<?php if (isset($edit_customer)) { echo base_url()."Sales/update_leads/".$cid; } else { echo base_url()."Sales/save_leads"; } ?>',{
                'name' : customer_name,
    ...
    function uploadfiledata(lid) {
    	...
    	if($('.upload')[0].files[0]) {
    		...
    		flnm = "";
    		$.ajax({
    			url: "<?php echo base_url().'Sales/uploadfile/'; ?>" + lid, // Url to which the request is send
