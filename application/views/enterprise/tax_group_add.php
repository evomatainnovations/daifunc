<main class="mdl-layout__content">
	...
	<div class="mdl-grid">
		...
		<?php if(isset($edit_tax_group)) {
			echo "<a href='".base_url().'Enterprise/delete_tax_group/'.$tid."'";
...
<script>
	$(document).ready(function() {
		...
		$('#submit').click(function(e) {
			...
			$.post('<?php if (isset($edit_tax_group)) { echo base_url()."Enterprise/update_tax_group/".$tid; } else { echo base_url()."Enterprise/save_tax_group"; } ?>', {
				'name' : group_name,
				'taxes' : group_taxes
			}, function(data, status, xhr) {
				window.location = '<?php echo base_url()."Enterprise/tax_group"; ?>';
			}, 'text');
