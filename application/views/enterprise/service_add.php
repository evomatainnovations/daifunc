	...
	<div class="mdl-grid">
		...
		<div class="mdl-cell mdl-cell--8-col">
			<div class="mdl-card mdl-shadow--4dp">
				<div class="mdl-card__title">
					<h2 class="mdl-card__title-text">Service Details</h2>
				</div>
				<div class="mdl-card__supporting-text">
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						...
						<label class="mdl-textfield__label" for="p_name">Enter Service Name</label>
					</div>
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						...
						<label class="mdl-textfield__label" for="p_sprice">Enter Service Sell Price</label>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="mdl-grid">
			...
			<?php if(isset($edit_product)) {
				echo "<a href='".base_url().'Enterprise/delete_service/'.$pid."'";
...
<script>
	$(document).ready(function() {
		...
		$('#submit').click(function(e) {
			...
			$.post('<?php if (isset($edit_product)) { echo base_url()."Enterprise/update_service/".$pid; } else { echo base_url()."Enterprise/save_service"; } ?>', {
				'name' : product_name,
				'alias' : product_alias,
				...
				window.location = '<?php echo base_url()."Enterprise/services"; ?>';
			}, 'text');
