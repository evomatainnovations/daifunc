		...
		<div class="mdl-cell mdl-cell--4-col">
			<div class="mdl-card mdl-shadow--4dp">
				<div class="mdl-card__title" style="height: 170px;">
					<h2 class="mdl-card__title-text"><?php echo $module_title; ?> follow up details</h2>
				</div>
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$('#submit').click(function(e) {
			...
			$.post("<?php echo base_url().'Enterprise/update_follow_up/'.$module.'/'.$sid;?>", {
				'remarks' : $('#remarks').val(),
				'remind' : $('#date-input-to').val(),
				
			}, function(data, status, xhr) {
				<?php 
					echo 'window.location = "'.base_url().'Enterprise/quotation_edit/'.$module.'/'.$sid.'"';
				?>
			}, "text");			
		});
